...
class EntryFlow(nn.Module):
    ...
    def __init__(self,input_channel=3):
        ...
        self.conv1 = nn.Sequential(
            nn.Conv2d(input_channel, 32, 3, padding=1, bias=False),
            nn.BatchNorm2d(32),
...
class Xception(nn.Module):
    ...
    def __init__(self, block, num_class=100,input_channel=3):
        super().__init__()
        self.entry_flow = EntryFlow(input_channel=input_channel)
...
def xception_cla(num_class=100,input_channel=3):
    return Xception(MiddleFLowBlock,num_class=num_class,input_channel=input_channel)
